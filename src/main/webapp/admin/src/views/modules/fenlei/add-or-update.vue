<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="部门分类" prop="bumenfenlei">
          <el-input v-model="ruleForm.bumenfenlei" 
              placeholder="部门分类" clearable  :readonly="ro.bumenfenlei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="部门分类" prop="bumenfenlei">
              <el-input v-model="ruleForm.bumenfenlei" 
                placeholder="部门分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='bumenfenlei'){
            this.ruleForm.bumenfenlei = obj[o];
	    this.ro.bumenfenlei = true;
            continue;
          }
	                    }
                              }
