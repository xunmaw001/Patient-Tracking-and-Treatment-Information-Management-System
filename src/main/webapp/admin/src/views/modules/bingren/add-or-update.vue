  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.xingbie"
                placeholder="性别" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="身高CM" prop="shengaoCM">
          <el-input v-model="ruleForm.shengaoCM" 
              placeholder="身高CM" clearable  :readonly="ro.shengaoCM"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="身高CM" prop="shengaoCM">
              <el-input v-model="ruleForm.shengaoCM" 
                placeholder="身高CM" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出生" prop="chusheng">
          <el-input v-model="ruleForm.chusheng" 
              placeholder="出生" clearable  :readonly="ro.chusheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出生" prop="chusheng">
              <el-input v-model="ruleForm.chusheng" 
                placeholder="出生" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="年龄" prop="nianling">
              <el-input v-model="ruleForm.nianling" 
                placeholder="年龄" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="体重KG" prop="tizhongKG">
          <el-input v-model="ruleForm.tizhongKG" 
              placeholder="体重KG" clearable  :readonly="ro.tizhongKG"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="体重KG" prop="tizhongKG">
              <el-input v-model="ruleForm.tizhongKG" 
                placeholder="体重KG" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="籍贯" prop="jiguan">
              <el-input v-model="ruleForm.jiguan" 
                placeholder="籍贯" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="居住地" prop="juzhudi">
          <el-select v-model="ruleForm.juzhudi" placeholder="请选择居住地">
            <el-option
                v-for="(item,index) in juzhudiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="居住地" prop="juzhudi">
	      <el-input v-model="ruleForm.juzhudi"
                placeholder="居住地" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingbie = true;
            continue;
	            	            ...
	            	            if(o=='shengaoCM'){
            this.ruleForm.shengaoCM = obj[o];
	    this.ro.shengaoCM = true;
            continue;
          }
	            	            if(o=='chusheng'){
            this.ruleForm.chusheng = obj[o];
	    this.ro.chusheng = true;
            continue;
          }
	            	            if(o=='nianling'){
	    ...
	    this.ro.jiguan = true;
            continue;
	            	            ...
	            	            if(o=='juzhudi'){
            this.ruleForm.juzhudi = obj[o];
	    this.ro.juzhudi = true;
            continue;
          }
	            	            if(o=='zhiye'){
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                ...
                                                                                                this.xingbieOptions = "男,女".split(',')
                                                                                                                                  this.juzhudiOptions = "城镇,农村".split(',')
                                                                                  },
                                                                                                                // 多级联动参数
                                                                                                                                              info(id) {
      this.$http({
